...
#---------------------------
#Add More Seurat plots here
#---------------------------
#dataobj

makeVlnPlot <- function(obj, features, splits = NULL){
    plot <- VlnPlot(obj, features = features, group.by = splits)
    return(plot)
}

makeDimPlot <- function(obj, reduction = NULL, groups = NULL, splits = NULL){
...
makeFeaturePlot <- function(obj, features, reduction, splits){
